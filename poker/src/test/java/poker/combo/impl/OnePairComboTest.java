...
class OnePairComboTest {
	...
	@DisplayName("Given a ROYAL_FLUSH hand the combo should not be a ONE_PAIR")
	public void testRoyalFlush(Hand hand) {
		assertNotEquals(ComboType.ONE_PAIR, pokerFacade.findCombo(hand).getComboType());
	}
	
	@ParameterizedTest(name = "#{index} - Test with Hand : {0}")
    @MethodSource("poker.combo.impl.util.HandCombo#getStraightFlushHands")
	@DisplayName("Given a STRAIGHT_FLUSH hand the combo should not be a ONE_PAIR")
	...
	@DisplayName("Given a FOUR_OF_A_KIND hand the combo should not be a ONE_PAIR")
	...
	@DisplayName("Given a FULL_HOUSE hand the combo should not be a ONE_PAIR")
	...
	@DisplayName("Given a FLUSH hand the combo should be a ONE_PAIR")
	...
	@DisplayName("Given a STRAIGHT hand the combo should not be a ONE_PAIR")
	...
	@DisplayName("Given a THREE_OF_A_KIND hand the combo should not be a ONE_PAIR")
	...
	@DisplayName("Given a TWO_PAIRS hand the combo should not be a ONE_PAIR")
	...
	@DisplayName("Given a ONE_PAIR hand the combo should be a ONE_PAIR")
	public void testOnePair(Hand hand) {
		assertEquals(ComboType.ONE_PAIR, pokerFacade.findCombo(hand).getComboType());
	}
}
