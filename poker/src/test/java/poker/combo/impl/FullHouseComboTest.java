...
class FullHouseComboTest {
	...
	@DisplayName("Given a ROYAL_FLUSH hand the combo should not be a FULL_HOUSE")
	public void testRoyalFlush(Hand hand) {
		assertNotEquals(ComboType.FULL_HOUSE, pokerFacade.findCombo(hand).getComboType());
	}
	
	@ParameterizedTest(name = "#{index} - Test with Hand : {0}")
    @MethodSource("poker.combo.impl.util.HandCombo#getStraightFlushHands")
	@DisplayName("Given a STRAIGHT_FLUSH hand the combo should not be a FULL_HOUSE")
	...
	@DisplayName("Given a FOUR_OF_A_KIND hand the combo should not be a FULL_HOUSE")
	...
	@DisplayName("Given a FULL_HOUSE hand the combo should be a FULL_HOUSE")
	public void testFullHouse(Hand hand) {
		assertEquals(ComboType.FULL_HOUSE, pokerFacade.findCombo(hand).getComboType());
	}
	
	@ParameterizedTest(name = "#{index} - Test with Hand : {0}")
    @MethodSource("poker.combo.impl.util.HandCombo#getFlushHands")
	@DisplayName("Given a FLUSH hand the combo should be a FULL_HOUSE")
	...
	@DisplayName("Given a STRAIGHT hand the combo should not be a FULL_HOUSE")
	...
	@DisplayName("Given a THREE_OF_A_KIND hand the combo should not be a FULL_HOUSE")
	...
	@DisplayName("Given a TWO_PAIRS hand the combo should not be a FULL_HOUSE")
	...
	@DisplayName("Given a ONE_PAIR hand the combo should not be a FULL_HOUSE")
