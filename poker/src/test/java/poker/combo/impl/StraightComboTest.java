...
class StraightComboTest {
	...
	@DisplayName("Given a ROYAL_FLUSH hand the combo should not be a STRAIGHT")
	public void testRoyalFlush(Hand hand) {
		assertNotEquals(ComboType.STRAIGHT, pokerFacade.findCombo(hand).getComboType());
	}
	
	@ParameterizedTest(name = "#{index} - Test with Hand : {0}")
    @MethodSource("poker.combo.impl.util.HandCombo#getStraightFlushHands")
	@DisplayName("Given a STRAIGHT_FLUSH hand the combo should not be a STRAIGHT")
	...
	@DisplayName("Given a FOUR_OF_A_KIND hand the combo should not be a STRAIGHT")
	...
	@DisplayName("Given a FULL_HOUSE hand the combo should not be a STRAIGHT")
	...
	@DisplayName("Given a FLUSH hand the combo should be a STRAIGHT")
	...
	@DisplayName("Given a STRAIGHT hand the combo should be a STRAIGHT")
	public void testStraight(Hand hand) {
		assertEquals(ComboType.STRAIGHT, pokerFacade.findCombo(hand).getComboType());
	}
	
	@ParameterizedTest(name = "#{index} - Test with Hand : {0}")
    @MethodSource("poker.combo.impl.util.HandCombo#getThreeOfAKindHands")
	@DisplayName("Given a THREE_OF_A_KIND hand the combo should not be a STRAIGHT")
	...
	@DisplayName("Given a TWO_PAIRS hand the combo should not be a STRAIGHT")
	...
	@DisplayName("Given a ONE_PAIR hand the combo should not be a STRAIGHT")
