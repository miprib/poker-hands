...
class FourOfAKindComboTest {
	...
	@DisplayName("Given a ROYAL_FLUSH hand the combo should not be a FOUR_OF_A_KIND")
	public void testRoyalFlush(Hand hand) {
		assertNotEquals(ComboType.FOUR_OF_A_KIND, pokerFacade.findCombo(hand).getComboType());
	}
	
	@ParameterizedTest(name = "#{index} - Test with Hand : {0}")
    @MethodSource("poker.combo.impl.util.HandCombo#getStraightFlushHands")
	@DisplayName("Given a STRAIGHT_FLUSH hand the combo should not be a FOUR_OF_A_KIND")
	...
	@DisplayName("Given a FOUR_OF_A_KIND hand the combo should be a FOUR_OF_A_KIND")
	public void testFourOfAKind(Hand hand) {
		assertEquals(ComboType.FOUR_OF_A_KIND, pokerFacade.findCombo(hand).getComboType());
	}
	
	@ParameterizedTest(name = "#{index} - Test with Hand : {0}")
    @MethodSource("poker.combo.impl.util.HandCombo#getFullHouseHands")
	@DisplayName("Given a FULL_HOUSE hand the combo should not be a FOUR_OF_A_KIND")
	...
	@DisplayName("Given a FLUSH hand the combo should be a FOUR_OF_A_KIND")
	...
	@DisplayName("Given a STRAIGHT hand the combo should not be a FOUR_OF_A_KIND")
	...
	@DisplayName("Given a THREE_OF_A_KIND hand the combo should not be a FOUR_OF_A_KIND")
	...
	@DisplayName("Given a TWO_PAIRS hand the combo should not be a FOUR_OF_A_KIND")
	...
	@DisplayName("Given a ONE_PAIR hand the combo should not be a FOUR_OF_A_KIND")
