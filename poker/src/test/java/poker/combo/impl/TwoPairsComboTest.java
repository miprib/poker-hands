...
class TwoPairsComboTest {
	...
	@DisplayName("Given a ROYAL_FLUSH hand the combo should not be a TWO_PAIRS")
	public void testRoyalFlush(Hand hand) {
		assertNotEquals(ComboType.TWO_PAIRS, pokerFacade.findCombo(hand).getComboType());
	}
	
	@ParameterizedTest(name = "#{index} - Test with Hand : {0}")
    @MethodSource("poker.combo.impl.util.HandCombo#getStraightFlushHands")
	@DisplayName("Given a STRAIGHT_FLUSH hand the combo should not be a TWO_PAIRS")
	...
	@DisplayName("Given a FOUR_OF_A_KIND hand the combo should not be a TWO_PAIRS")
	...
	@DisplayName("Given a FULL_HOUSE hand the combo should not be a TWO_PAIRS")
	...
	@DisplayName("Given a FLUSH hand the combo should be a TWO_PAIRS")
	...
	@DisplayName("Given a STRAIGHT hand the combo should not be a TWO_PAIRS")
	...
	@DisplayName("Given a THREE_OF_A_KIND hand the combo should not be a TWO_PAIRS")
	...
	@DisplayName("Given a TWO_PAIRS hand the combo should be a TWO_PAIRS")
	public void testTwoPairs(Hand hand) {
		assertEquals(ComboType.TWO_PAIRS, pokerFacade.findCombo(hand).getComboType());
	}
	
	@ParameterizedTest(name = "#{index} - Test with Hand : {0}")
    @MethodSource("poker.combo.impl.util.HandCombo#getOnePairHands")
	@DisplayName("Given a ONE_PAIR hand the combo should not be a TWO_PAIRS")
