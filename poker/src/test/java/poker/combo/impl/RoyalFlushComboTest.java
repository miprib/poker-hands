...
public class RoyalFlushComboTest {
	...
	@DisplayName("Given a ROYAL_FLUSH hand the combo should be a ROYAL_FLUSH")
	public void testRoyalFlush(Hand hand) {
		assertEquals(ComboType.ROYAL_FLUSH, pokerFacade.findCombo(hand).getComboType());
	}
	
	@ParameterizedTest(name = "#{index} - Test with Hand : {0}")
    @MethodSource("poker.combo.impl.util.HandCombo#getStraightFlushHands")
	@DisplayName("Given a STRAIGHT_FLUSH hand the combo should not be a ROYAL_FLUSH")
	public void testStraightFlush(Hand hand) {
		assertNotEquals(ComboType.ROYAL_FLUSH, pokerFacade.findCombo(hand).getComboType());
	}
	
	@ParameterizedTest(name = "#{index} - Test with Hand : {0}")
    @MethodSource("poker.combo.impl.util.HandCombo#getFourOfAKindHands")
	@DisplayName("Given a FOUR_OF_A_KIND hand the combo should not be a ROYAL_FLUSH")
	...
	@DisplayName("Given a FULL_HOUSE hand the combo should not be a ROYAL_FLUSH")
	...
	@DisplayName("Given a FLUSH hand the combo should not be a ROYAL_FLUSH")
	...
	@DisplayName("Given a STRAIGHT hand the combo should not be a ROYAL_FLUSH")
	...
	@DisplayName("Given a THREE_OF_A_KIND hand the combo should not be a ROYAL_FLUSH")
	...
	@DisplayName("Given a TWO_PAIRS hand the combo should not be a ROYAL_FLUSH")
	...
	@DisplayName("Given a ONE_PAIR hand the combo should not be a ROYAL_FLUSH")
